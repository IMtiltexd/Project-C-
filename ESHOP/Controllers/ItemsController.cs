    ...
    public class ItemsController : Controller
    {
        ...
        public IActionResult Create()
        {
            if (User.IsInRole("ADMIN"))
            {
                ...
                ViewBag.Manufacturer = new SelectList(_context.Manufacturers, "Id", "Title");
        ...
        public IActionResult Edit(int id)
        {
            if (User.IsInRole("ADMIN"))
            {
                ...
                ViewBag.Manufacturer = new SelectList(_context.Manufacturers, "Id", "Title", item?.ManufacturerId);
